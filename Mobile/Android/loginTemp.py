...
def SignUp(myEmail,myFirst,mySur,myPass):
    ...
    WebDriverWait(driver, 22).until(EC.presence_of_element_located((By.XPATH, "//android.view.View/android.widget.Button")))
    myEmail = myEmail
    myFirstName = myFirst
    mySurName = mySur
    myPassword = myPass
    ...
    continueWith.click()
    driver.implicitly_wait(3)
    WebDriverWait(driver, 22).until(EC.presence_of_element_located((By.XPATH, "//android.widget.EditText")))

    enterEmail = driver.find_elements(AppiumBy.XPATH,"//android.widget.EditText")
    enterEmail[0].click()
    driver.implicitly_wait(2)
    enterEmail[0].send_keys(myEmail)
    ###  next button ##########
    driver.implicitly_wait(2)
    btn = driver.find_elements(AppiumBy.CLASS_NAME,"android.widget.Button")
    btn[1].click()
    ...
    editTexts = driver.find_elements(AppiumBy.XPATH,"//android.widget.EditText")
...
def login(myEve,mySum,myIndex):
    ...
    WebDriverWait(driver, 22).until(EC.presence_of_element_located((By.XPATH, "//android.view.View/android.view.View/android.view.View/android.view.View/child::android.widget.Button[1]")))
    ...
    #####################   Manage Events  ####################
    time.sleep(3)
    WebDriverWait(driver, 22).until(EC.presence_of_element_located((By.XPATH,"//android.widget.Button[@content-desc='Log out']")))
    ...
    WebDriverWait(driver, 22).until(EC.presence_of_element_located((By.XPATH, "//android.view.View/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View/child::android.view.View[8]")))
    ...
    actions = ActionChains(driver)
    actions.w3c_actions = ActionBuilder(driver, mouse=PointerInput(interaction.POINTER_TOUCH, "touch"))
    actions.w3c_actions.pointer_action.move_to(photoOptions[myIndex])
    actions.w3c_actions.pointer_action.click_and_hold()
    actions.w3c_actions.pointer_action.pause(0.5)
    actions.w3c_actions.pointer_action.release()
    actions.perform()
...
def reserveEvent():
    ...
    # WebDriverWait(driver, 52).until(EC.presence_of_element_located((By.XPATH,"//android.widget.ImageView")))

    WebDriverWait(driver, 52).until(EC.presence_of_element_located((By.XPATH,"//android.view.View[@content-desc='Organizer']")))
    ...
    driver.hide_keyboard()
    texts[4].click()
    texts[4].send_keys("omar.sendiony@gmail.com")
    driver.hide_keyboard()
